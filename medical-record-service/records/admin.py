...
class DiagnosisAdmin(admin.ModelAdmin):
    list_display = ('id', 'medical_record', 'doctor_id', 'diagnosis_code', 'diagnosis_date')
...
class ImmunizationAdmin(admin.ModelAdmin):
    list_display = ('id', 'medical_record', 'vaccine_name', 'administration_date', 'dose')
...
class MedicationAdmin(admin.ModelAdmin):
    list_display = ('id', 'medical_record', 'medication_name', 'dosage', 'start_date', 'end_date')
    search_fields = ('medication_name',)
    list_filter = ('start_date', 'end_date')

@admin.register(VitalSign)
class VitalSignAdmin(admin.ModelAdmin):
    list_display = ('id', 'medical_record', 'vital_type', 'value', 'unit', 'recorded_at')
    search_fields = ('vital_type',)
    list_filter = ('recorded_at',)

@admin.register(LabTest)
class LabTestAdmin(admin.ModelAdmin):
    list_display = ('id', 'medical_record', 'test_name', 'ordered_by', 'ordered_at')
